...
@:bitmap("res/img/ui_window_select.png") class UIWindowSelect extends BitmapData {}
...
@:bitmap("res/img/ui_button_load.png")   class UIButtonLoad   extends BitmapData {}
@:bitmap("res/img/ui_button_text.png")   class UIButtonText   extends BitmapData {}
